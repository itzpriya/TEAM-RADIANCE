...
const address = '0xe1DfD8b9383B1C76f245F9BCA320D5854AFA47c9';
...
const createRetailer = async (retailerHashedEmail, retailerName, retailerLocation) => {
	let account = await getAccounts();
    return contractInstance.methods.createRetailer(retailerHashedEmail, retailerName, retailerLocation).send({ from: account[0], gas: 3000000 });
}
